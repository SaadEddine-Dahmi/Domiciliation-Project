...
function authHeaders(): Record<string, string> {
  ...
  try {
    // FIX: this used to read 'astfisc_auth', a stale key from an earlier
    // pass — every other page in the app writes/reads 'app_auth', so this
    // page was silently sending unauthenticated requests (401s, empty list).
