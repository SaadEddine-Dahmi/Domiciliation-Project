...
const filtered = computed(() => {
  ...
  return clientItems.value.filter(
    (c) =>
...
async function submitRep(): Promise<void> {
  ...
  try {
    if (repMode.value === "create") {
      const res = await representantService.create(selectedClientId.value, {
        ...repForm,
      });
      representant.value = res.data;
      success("Représentant ajouté");
    } else {
      const res = await representantService.update(selectedClientId.value, {
        ...repForm,
      });
      representant.value = res.data;
...
async function deleteRep(): Promise<void> {
  if (!selectedClientId.value || !confirm("Supprimer le représentant ?"))
    return;
  try {
      ...
      <div
        ...
        <div class="flex items-center gap-2 flex-wrap shrink-0">
          <span
            ...
            >{{ client.statut }}</span
          >
          <NuxtLink :to="`/admin/clients/${client.id}`" class="btn btn-outline btn-sm">
  Voir détail
</NuxtLink>
          <button
            class="btn btn-outline btn-sm"
            @click="openRepModal(client.id)">
            Représentant
          </button>
    ...
    <div
      ...
      <button
        v-if="!search"
        class="btn btn-gold btn-md mt-4"
        @click="openCreate">
        ...
        <div
          ...
          <div class="flex-1 overflow-y-auto px-6 py-5">
            <form class="space-y-5" @submit.prevent="submitEntreprise">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div class="sm:col-span-2">
                  ...
                  <input
                    ...
                    class="f-input"
                    required
                    placeholder="BRONX IMMOBILIER SARL" />
                </div>
                <div>
              ...
              <p
                class="text-xs uppercase tracking-widest font-bold pt-2"
                style="color: #c8a96e">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div class="sm:col-span-2">
                  ...
                  <p
                    v-if="
                      modalMode === 'edit' &&
                      form.client_password.length > 0 &&
                      form.client_password.length < 8
                    "
                  ...
                  <p
                    v-else-if="
                      modalMode === 'edit' && form.client_password.length >= 8
                    "
              ...
              <p v-if="serverError" class="text-red-400 text-sm px-0">
                {{ serverError }}
              </p>
    ...
    <Teleport to="body">
      <div
        ...
        <div
          class="card w-full max-w-xl max-h-[90vh] flex flex-col"
          @click.stop>
          <!-- Header -->
          <div
            class="flex items-center justify-between px-6 pt-6 pb-4 shrink-0"
          ...
          <div class="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <!-- View mode -->
            <div
              v-else-if="representant && repMode === 'view'"
              class="space-y-4">
              <div
                ...
                <div
                  ...
                  <p>
                    <span class="font-medium" style="color: var(--app-text)"
                      >CIN :</span
                    >
                    {{ representant.cin }}
                  </p>
              ...
              <div class="flex gap-2 justify-end">
                <button class="btn btn-danger btn-sm" @click="deleteRep">
                  Supprimer
                </button>
                <button class="btn btn-gold btn-md" @click="openRepEdit">
                  Modifier
                </button>
              </div>
            </div>
            ...
            <!-- Create / Edit form -->
            <div
              v-else-if="repMode === 'create' || repMode === 'edit'"
              class="space-y-4">
              <p
                class="text-xs uppercase tracking-widest font-bold"
                style="color: #c8a96e">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    v-model="repForm.date_naissance"
                    class="f-input"
                    type="date" />
                </div>
                <div>
