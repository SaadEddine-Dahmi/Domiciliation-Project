<?php
// Client companies being domiciled. Each entreprise belongs to
// exactly one domiciliataire (tenant owner) and optionally links
// to a client-portal user account.
